...
- In this first DSL pass, gains are concentrated in overflow-style unseen mismatch cases (`gs=7`), while adjacent mismatch slices such as `gs=3` and `gs=5` remained largely unchanged.
